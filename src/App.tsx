...
import { Camera, Upload, AlertCircle, Smile, Shuffle, Clock, Check, MessageSquare, Music, Lightbulb, Dices } from "lucide-react";
...
const activitySuggestions = {
  happy: [
    { title: "Dance Party", description: "Turn up your favorite music and dance like nobody's watching!" },
    { title: "Gratitude Journal", description: "Write down 5 things you're grateful for today." },
    { title: "Random Acts of Kindness", description: "Do something nice for someone else to spread the joy." },
    { title: "Creative Project", description: "Start a fun art project or craft that makes you smile." },
    { title: "Nature Walk", description: "Take a walk outside and appreciate the beauty around you." },
    { title: "Call a Friend", description: "Share your good mood with someone you care about." }
  ],
  sad: [
    { title: "Comfort Movie", description: "Watch a favorite film that always lifts your spirits." },
    { title: "Gentle Movement", description: "Try some light yoga or stretching to release tension." },
    { title: "Cozy Reading", description: "Curl up with a good book and a warm drink." },
    { title: "Mindful Breathing", description: "Practice deep breathing for a few minutes to center yourself." },
    { title: "Soothing Music", description: "Listen to calming music that resonates with you." },
    { title: "Warm Bath", description: "Take a relaxing bath with essential oils or bath salts." }
  ],
  angry: [
    { title: "Physical Release", description: "Go for a run or do some high-intensity exercise to release energy." },
    { title: "Journaling", description: "Write down your thoughts to process your feelings." },
    { title: "Stress Ball", description: "Squeeze a stress ball or punch a pillow to release tension safely." },
    { title: "Deep Breathing", description: "Practice 4-7-8 breathing to calm your nervous system." },
    { title: "Nature Break", description: "Step outside for fresh air and a change of scenery." },
    { title: "Progressive Relaxation", description: "Tense and release each muscle group to release physical tension." }
  ],
  surprised: [
    { title: "Mindful Moment", description: "Take a moment to ground yourself and process the surprise." },
    { title: "Creative Expression", description: "Channel your energy into drawing or writing about your feelings." },
    { title: "Curiosity Exploration", description: "Learn something new about a topic that interests you." },
    { title: "Spontaneous Adventure", description: "Do something unplanned but fun to embrace the unexpected." },
    { title: "Photo Walk", description: "Take photos of interesting things you normally wouldn't notice." },
    { title: "New Recipe", description: "Try cooking something you've never made before." }
  ],
  neutral: [
    { title: "Skill Building", description: "Learn something new or practice a skill you've been wanting to improve." },
    { title: "Declutter Space", description: "Organize a small area of your home for a sense of accomplishment." },
    { title: "Mindful Walking", description: "Take a walk and pay attention to all your senses." },
    { title: "Goal Setting", description: "Reflect on your goals and plan some next steps." },
    { title: "Podcast Time", description: "Listen to an interesting podcast on a topic you enjoy." },
    { title: "People Watching", description: "Sit in a public place and observe the world around you." }
  ],
  // Map other emotions to appropriate activities
  fear: [
    { title: "Grounding Exercise", description: "Practice the 5-4-3-2-1 technique to ground yourself in the present." },
    { title: "Calming Visualization", description: "Imagine a peaceful place where you feel safe and secure." },
    { title: "Gentle Stretching", description: "Release tension with slow, gentle stretches." },
    { title: "Support Call", description: "Call a trusted friend or family member for support." },
    { title: "Comfort Object", description: "Hold or use an object that brings you comfort and security." },
    { title: "Positive Affirmations", description: "Repeat calming affirmations that help you feel safe." }
  ],
  disgust: [
    { title: "Fresh Air", description: "Open windows or go outside for fresh air to clear your mind." },
    { title: "Clean Space", description: "Tidy up your immediate environment to create a fresh feeling." },
    { title: "Pleasant Scents", description: "Use essential oils or candles with scents you enjoy." },
    { title: "Hand Washing Ritual", description: "Practice mindful hand washing as a cleansing ritual." },
    { title: "Sensory Reset", description: "Focus on pleasant textures, sounds, or visuals to reset your senses." },
    { title: "Boundary Setting", description: "Reflect on and write down healthy boundaries you want to maintain." }
  ]
};
...
const chatPrompts = [
  { text: "Tell me interesting facts about my current mood", icon: <Lightbulb size={16} /> },
  { text: "Suggest music that matches how I'm feeling", icon: <Music size={16} /> },
  { text: "What activities would help improve my mood?", icon: <Clock size={16} /> }
];
...
function App() {
  ...
  const shuffleActivities = () => {
    ...
    const activities = activitySuggestions[emotionCategory as keyof typeof activitySuggestions] || activitySuggestions.neutral;
    const shuffled = [...activities].sort(() => 0.5 - Math.random());
    
    // Reset any selections when shuffling
    setSelectedActivities([]);
    setDisplayedActivities(shuffled.slice(0, 3).map(activity => ({
      ...activity,
      selected: false,
      time: 5
    })));
  ...
  const toggleActivitySelection = (index: number) => {
    ...
    if (updatedActivities[index].selected) {
      ...
      setSelectedActivities(prev => prev.filter(a => a.title !== updatedActivities[index].title));
    }
  };
  ...
  const handleChatSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      switch(emotionCategory) {
        case 'happy':
          response = "Since you're feeling happy, you might also enjoy calling a friend to share your good mood, starting a creative project, or planning something fun for the weekend!";
          break;
        case 'sad':
          response = "I understand you're feeling down. Sometimes gentle self-care like a warm drink, a comfort show, or wrapping yourself in a cozy blanket can help. Would you like more suggestions?";
          break;
        case 'angry':
          response = "When feeling angry, it can help to try physical activities to release tension, like a brisk walk or some push-ups. Would you like me to suggest some calming techniques?";
          break;
        case 'surprised':
          response = "Surprise can be energizing! You might channel that energy into trying something new or spontaneous today. Would you like some ideas for quick adventures?";
          break;
        case 'fear':
          response = "When feeling fearful, grounding exercises can help bring you back to the present moment. Would you like me to suggest some techniques?";
          break;
        case 'disgust':
          response = "For feelings of disgust, creating a clean, fresh environment can help reset your senses. Would you like more ideas for sensory reset activities?";
          break;
        case 'neutral':
          response = "A neutral mood is a great time for reflection or planning. You might try journaling about your goals or organizing something that's been on your mind. What interests you?";
          break;
        default:
          response = "I'd be happy to suggest more activities based on how you're feeling. What kinds of activities do you usually enjoy?";
      }
  ...
  const getEmotionBackground = () => {
    const emotionCategory = mapEmotionToCategory(emotion);
    return emotionBackgrounds[emotionCategory as keyof typeof emotionBackgrounds] || emotionBackgrounds.neutral;
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div id="app-section" className="container mx-auto px-8 md:px-12 lg:px-16 py-16">
          ...
          <div className="mt-16">
            ...
            {activityInProgress && currentActivity && (
              <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 border-l-4 border-green-500 rounded-lg shadow-lg p-8 mb-12">
                <h2 className="text-2xl font-semibold text-green-400 mb-3">Activity in Progress</h2>
                <p className="text-xl font-medium mb-3 text-white">{currentActivity.title}</p>
                <p className="text-gray-300 mb-6 text-lg">{currentActivity.description}</p>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {activityQueue.slice(1).map((activity, idx) => (
                        <div key={idx} className="bg-gray-800 px-4 py-2 rounded-full text-sm">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-3xl font-mono font-bold text-green-400">{formatTimeRemaining()}</span>
                  </div>
                  <button 
            ...
            {!activityInProgress && (
              <div className="rounded-lg shadow-lg p-8 mb-12 border border-gray-700 bg-gray-800/50">
                <div className="flex justify-between items-center mb-8">
                  <h2 className="text-3xl font-semibold text-white">Suggested Activities for Your Mood</h2>
                  <p className="text-gray-400 text-lg">Select one or more activities to start</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  {displayedActivities.map((activity, index) => {
                    ...
                    const bgClass = activity.selected 
                      ...
                      : `${emotionBackgrounds[emotionCategory as keyof typeof emotionBackgrounds].replace('border-', '')} border-gray-700 hover:bg-gray-700/80`;
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="text-2xl font-bold text-indigo-300">{activity.title}</h3>
                          <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                            activity.selected ? 'border-indigo-400 bg-indigo-600' : 'border-gray-500'
                          }`}>
                            {activity.selected && <Check size={16} className="text-white" />}
                          </div>
                        </div>
                        <p className="text-gray-300 mb-5 text-lg">{activity.description}</p>
                        
                        {activity.selected && (
                          <div className="mt-4">
                            <p className="text-base text-gray-400 mb-2">Time (minutes):</p>
                            <div className="flex items-center">
                              <button 
                                onClick={(e) => {
                                  e.stopPropagation();
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4">
                  ...
                  <button 
                    ...
                    style={{ cursor: selectedActivities.length > 0 ? 'pointer' : 'default' }}
                  >
                    <Check className="mr-2 h-5 w-5" />
                    Start {selectedActivities.length > 0 ? `${selectedActivities.length} ` : ''}Activities
                  </button>
                </div>
              </div>
            )}
            ...
            {/* AI Chatbot Section */}
            <div ref={chatSectionRef} className="bg-gray-800 rounded-lg shadow-lg p-8">
              <div 
                className="flex justify-between items-center mb-6 cursor-pointer"
                onClick={handleOpenChat}
              >
                <h2 className="text-3xl font-semibold text-white">Need more suggestions?</h2>
              ...
              {showChatbot && (
                <div className="border border-gray-700 rounded-lg">
                  <div className="h-96 overflow-y-auto p-6 bg-gray-900 custom-scrollbar">
                    {chatMessages.length === 0 ? (
                      <div className="text-center text-gray-500 mt-8 mb-10">
                        ...
                        <p className="mb-8 text-lg">Ask for personalized activity suggestions based on your mood!</p>
                  ...
                  <form onSubmit={handleChatSubmit} className="flex border-t border-gray-700">
                    <input
                      type="text"
                      value={userInput}
